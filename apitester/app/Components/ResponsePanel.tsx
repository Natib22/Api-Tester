...
const ResponsePanel = () => {
  ...
  return (
    <div className='w-full flex flex-col max-pc:min-h-80  bg-lightgrey max-pc:rounded-lg pc:rounded-tr-lg pc:rounded-br-lg  overflow-hidden'>
      ...
      {
        sentStatus ? <div className='pc:overflow-scroll pc:max-h-[75vh]'> {typeof(response) == Array ? response.map : response.  } </div> : <div className='m-auto flex flex-col items-center justify-center'> <svg xmlns="http://www.w3.org/2000/svg" height="90px" viewBox="0 -960 960 960" width="90px" fill="#666666"><path d="m358-316 122-122 122 122 42-42-122-122 122-122-42-42-122 122-122-122-42 42 122 122-122 122 42 42ZM140-160q-24 0-42-18t-18-42v-520q0-24 18-42t42-18h680q24 0 42 18t18 42v520q0 24-18 42t-42 18H140Zm0-60h680v-520H140v520Zm0 0v-520 520Z"/></svg> 
